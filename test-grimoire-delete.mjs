/**
 * Test script for GrimoireEntry deletion endpoint
...
async function runTests() {
  console.log('🧪 Testing GrimoireEntry Deletion Endpoint\n');
  ...
  try {
    ...
    // 7. Test unauthorized deletion (no auth)
